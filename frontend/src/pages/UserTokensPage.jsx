// src/pages/UserTokensPage.jsx
// User Tokens Page Component
// This component displays the user's token collection along with wallet connection information.
      ...
      <main className={`relative pt-32 ${publicKey ? 'mt-8' : ''} pb-20 px-4 text-white`}>
        <div className="max-w-7xl mx-auto">
          ...
          {!publicKey ? (
            ...
            // Render the user's tokens list when wallet is connected
            <UserTokensList />
          )}
        </div>
      </main>
